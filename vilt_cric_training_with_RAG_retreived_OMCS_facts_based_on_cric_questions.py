...
2. The retrieval process of omcs_facts is based on the Questions of CRIC and not based on the knowledge_fact provided with CRIC.
"""
...
path = './vilt_omcs_trained_questions.txt'
...
# Attaching the top 1-fact before the question based on questions.

print('\nAttaching 1-Knowledge Fact Based on attached Questions')

for i in tqdm(range(len(questionList))):

    currentQuestion = questionList[i]
    
    factsToBeAttached = findTop1RelevantFacts(currentQuestion)
...
# Attaching Top-1 fact before the questions of val set based on the CRIC_questions

print('\nAttaching 1 Knowledge fact before the questions based on the CRIC_questions')
...
# Attaching 1 knowledge fact from OMCS with the Questions based on the CRIC_questions

print(f'\nAttaching 1-knowledge fact with the Questions based on the CRIC_questions')
...
for epoch in tqdm(range(10)):  
    ...
    save_path = os.path.join('./model_chkpts/vilt_omcs_facts_based_on_cric_questions/', 'vilt_trained_question_mod_' + str(epoch+1) + '_KG')
